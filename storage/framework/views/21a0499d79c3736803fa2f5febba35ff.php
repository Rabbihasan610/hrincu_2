...
<div class="file-upload-component">
    <div class="upload-container">
        ...
        <div class="upload-title"><?php echo app('translator')->get('Upload File'); ?></div>
        <div class="upload-subtitle"><?php echo app('translator')->get('Drag & drop or click to browse (any file type up to 2MB)'); ?></div>
        <div class="file-name"></div>

        <input type="file" class="file-input" accept="*" name="<?php echo e($inputName); ?>">
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\xampp\htdocs\hrincu_2\resources\views/components/file-upload.blade.php ENDPATH**/ ?>