...
<div>
    <form action="<?php echo e(route('admin.our-services.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-12 col-md-8 col-lg-8">
                ...
                <div class="form-group my-2">
                    ...
                    <input type="text" name="title_ar" id="title_ar" class="form-control" value="<?php echo e(old('title_ar')); ?>" required>
                </div>
                ...
                <div class="form-group my-2">
                    ...
                    <select name="status" id="status" class="form-control" required>
                        ...
                        <option value="inactive" <?php echo e(old('status') === 'inactive' ? 'selected' : ''); ?>><?php echo app('translator')->get('Inactive'); ?></option>
                    </select>
                </div>
                ...
                <button type="submit" class="btn btn-primary"><?php echo app('translator')->get('Submit Service'); ?></button>
            ...
            <div class="col-12 col-md-4 col-lg-4">
                <div class="card my-4">
                    ...
                    <div class="card-body" id="extra-fields-container">
                        <?php
                            $extraFields = old('form_extra_fields', []);
                        ?>
                        ...
                        <div class="form-row mb-3 extra-field" data-index="<?php echo e($index); ?>">
                            ...
                            <div class="col-12 options-container">
                                ...
                                <input type="text" name="form_extra_fields[<?php echo e($index); ?>][options]" class="form-control options-input" placeholder="Option 1, Option 2, Option 3" value="<?php echo e(is_array($field['options'] ?? null) ? implode(', ', $field['options']) : ($field['options'] ?? '')); ?>" required>
                            </div>
                            <?php else: ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.extra-field').each(function() {
            ...
            if (['select', 'radio', 'checkbox'].includes(fieldType)) {
                optionsContainer.removeClass('d-none');
                optionsContainer.find('.options-input').prop('required', true);
            }
        });
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Create Our Service'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hrincu_2\resources\views/admin/ourservice/create.blade.php ENDPATH**/ ?>