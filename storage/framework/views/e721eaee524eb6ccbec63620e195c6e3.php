                        ...
                        <table class="table">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('Company Name'); ?></th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td> <?php echo e($service?->service?->lang('title')); ?>  </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status','data' => ['data' => $service,'url' => route('admin.service.request.status', $service->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($service),'url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.service.request.status', $service->id))]); ?>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('admin.service.request.show', $service->id)); ?>">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" class="confirmationBtn"
                                                            data-action="<?php echo e(route('admin.service.request.delete', $service->id)); ?>"
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Service Requests'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\hrincu_v2\resources\views/admin/services/service-request/index.blade.php ENDPATH**/ ?>