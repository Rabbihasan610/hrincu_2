<div class="mt-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <label class="flex items-center p-3 border border-blue-500 rounded-md cursor-pointer <?php echo e(request()->type == 'job-seeker' ? 'bg-blue-50' : ''); ?>">
            <input type="radio" name="register-as" <?php echo e(request()->type == 'job-seeker' ? 'checked' : ''); ?> class="navigation form-radio text-blue-600 rounded mr-2" data-type="job-seeker">
        ...
        <label class="flex items-center p-3 border border-gray-300 rounded-md cursor-pointer <?php echo e(request()->type == 'employer' ? 'bg-blue-50' : ''); ?>">
            <input type="radio" name="register-as" <?php echo e(request()->type == 'employer' ? 'checked' : ''); ?>  class="navigation form-radio text-blue-600 rounded mr-2" data-type="employer">
        ...
        <label class="flex items-center p-3 border border-gray-300 rounded-md cursor-pointer <?php echo e(request()->type == 'service-provider' ? 'bg-blue-50' : ''); ?>">
            <input type="radio" name="register-as" <?php echo e(request()->type == 'service-provider' ? 'checked' : ''); ?> class="navigation form-radio text-blue-600 rounded mr-2" data-type="service-provider">
...
<?php /**PATH E:\xampp\htdocs\hrincu_2\resources\views/user/auth/navigation.blade.php ENDPATH**/ ?>