...
<section class="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
    <div class="max-w-4xl mx-auto overflow-hidden">
        ...
        <div class="mb-6">
            <p class="block text-gray-700 text-base font-medium mb-3">Register as</p>
            <div class="flex flex-col sm:flex-row sm:space-x-8 space-y-3 sm:space-y-0">
                <label class="inline-flex items-center w-full border-1 py-2 px-2">
                    <input type="checkbox" name="registerAs" value="jobSeeker" class="form-checkbox h-5 w-5 text-blue-600 rounded focus:ring-blue-500">
                    <span class="ml-2 text-gray-700 text-sm">Job Seeker</span>
                </label>
                <label class="inline-flex items-center w-full border-1 py-2 px-2">
                    <input type="checkbox" name="registerAs" value="employer" class="form-checkbox h-5 w-5 text-blue-600 rounded focus:ring-blue-500" checked>
                    <span class="ml-2 text-blue-600 text-sm">Employer</span>
                </label>
                <label class="inline-flex items-center w-full border-1 py-2 px-2">
                    <input type="checkbox" name="registerAs" value="serviceProvider" class="form-checkbox h-5 w-5 text-blue-600 rounded focus:ring-blue-500">
                    <span class="ml-2 text-gray-700 text-sm">Service Provider</span>
                </label>
            </div>
        </div>
