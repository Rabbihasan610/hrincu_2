...
<footer class="bg-[#071d23] text-white text-sm pt-10 pb-5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
            class="border border-gray-600 h-[6vh] rounded px-5 pt-3 pb-2 mb-10 grid grid-cols-1 md:grid-cols-3 gap-4 text-gray-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-gray-300">
            <div>
                ...
                <div class="flex space-x-3 text-lg">
                    <?php $__currentLoopData = $socialMediaElements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $socialMediaElement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(@$socialMediaElement->data_values->link); ?>" class="hover:text-blue-400 m-3"
                            target="_blank"><?php echo @$socialMediaElement->data_values->icon ?></a>
            ...
            <div>
                ...
                <ul class="space-y-1 text-sm">
                    <li>&gt;&gt;<a href="<?php echo e(route('user.register', ['type' => 'job-seeker'])); ?>"><?php echo app('translator')->get('Register as a Job Seeker'); ?></a>
                    </li>
                    <li>&gt;&gt;<a href="<?php echo e(route('user.register', ['type' => 'employer'])); ?>"><?php echo app('translator')->get('Register as an Employer'); ?></a>
                    </li>
                    <li>&gt;&gt;<a
                            href="<?php echo e(route('user.register', ['type' => 'service-provider'])); ?>"><?php echo app('translator')->get('Register as a Service Provider'); ?></a>
                    </li>
        ...
        <div
            class="mt-10 border-t border-gray-600 pt-5 flex flex-col lg:flex-row justify-between items-center text-gray-400">
            ...
            <div class="flex items-center space-x-2">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Visa.svg/100px-Visa.svg.png"
                    class="h-6" alt="Visa" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Mastercard_2019_logo.svg/100px-Mastercard_2019_logo.svg.png"
                    class="h-6" alt="Mastercard" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/a/a8/Paypal_Servise.jpg" class="h-6"
                    alt="Paypal" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/b/b0/Apple_Pay_logo.svg" class="h-6"
                    alt="Apple Pay" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/f/f2/Google_Pay_Logo.svg" class="h-6"
                    alt="Google Pay" />
            </div>
        </div>
    </div>
