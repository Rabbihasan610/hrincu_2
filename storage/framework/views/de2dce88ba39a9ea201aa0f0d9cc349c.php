    ...
    <ul class="flex space-x-4">
      ...
      <li class="relative group">
        ...
        <ul class="absolute right-0 w-40 mt-1 bg-white text-black rounded shadow-md hidden group-hover:block z-50">
          <li><a href="#" class="block px-4 py-2 hover:bg-gray-100"><?php echo app('translator')->get('Sign In'); ?></a></li>
...
<nav class="bg-gray-100 shadow">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <div class="hidden md:flex space-x-6 items-center">
        ...
        <a href="#" class="ml-2 px-4 py-2 bg-purple-700 text-white rounded hover:bg-purple-800 transition"><?php echo app('translator')->get('Submit'); ?></a>
      </div>
    </div>
  </div>
  ...
  <div class="md:hidden hidden" id="showMenu">
    <div class="px-4 pt-2 pb-4 space-y-2">
      <a href="<?php echo e(url('/')); ?>" class="block text-gray-700 hover:text-purple-700 text-sm">Home</a>
      <a href="<?php echo e(route('about')); ?>" class="block text-gray-700 hover:text-purple-700 text-sm">About Us</a>
      <a href="<?php echo e(route('service')); ?>" class="block text-gray-700 hover:text-purple-700 text-sm">Our Services</a>
      <a href="<?php echo e(route('targeted.sector')); ?>" class="block text-gray-700 hover:text-purple-700 text-sm">Targeted Sectors</a>
      <a href="<?php echo e(route('training.program')); ?>" class="block text-gray-700 hover:text-purple-700 text-sm">Training Programs</a>
      <a href="<?php echo e(route('community.engagement')); ?>" class="block text-gray-700 hover:text-purple-700 text-sm">Community Engagement</a>
      <a href="<?php echo e(route('licenses.document')); ?>" class="block text-gray-700 hover:text-purple-700 text-sm">Documents & Certificate</a>
