                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td> <img src="<?php echo e(getImage(getFilePath('service') . '/' . $service->image)); ?>" alt="image" class="rounded" style="width: 50px"> </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status','data' => ['data' => $service,'url' => route('admin.service.status', $service->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($service),'url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.service.status', $service->id))]); ?>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('admin.service.duplicate', $service->id)); ?>">
...
<?php endif; ?>
        <a href="<?php echo e(route('admin.service.create')); ?>" class="btn btn-primary"> <i class="fa-solid fa-plus"></i><?php echo app('translator')->get('Add New'); ?></a>
    </div>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', ['title' => 'Services'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hrincu_2\resources\views/admin/services/service/index.blade.php ENDPATH**/ ?>