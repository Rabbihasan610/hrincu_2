...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('sections.ourservice_request', ['is_home_page' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section class="bg-[#3b0764] py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-20">
        <div class="max-w-7xl mx-auto text-white">
            ...
            <ul class="text-base sm:text-sm md:text-base space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                <li class="text-sm sm:text-base"><?php echo app('translator')->get('Looking for qualified candidates?'); ?></li>
                <li class="text-sm sm:text-base"><?php echo app('translator')->get('Need to train your team?'); ?></li>
                <li class="text-sm sm:text-base"><?php echo app('translator')->get('Seeking smart HR solutions?'); ?></li>
                <li class="text-sm sm:text-base"><?php echo app('translator')->get('Start now — well guide you step by step'); ?></li>
            </ul>
    
            <div class="flex flex-row xs:flex-row gap-3 sm:gap-4">
                <a href="<?php echo e(route('submit.resume')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-1.5 px-4 sm:py-2.5 sm:px-5 md:py-3 md:px-6 rounded-md transition duration-300 ease-in-out text-center text-sm sm:text-base">
                    <?php echo app('translator')->get('Submit Request'); ?>
                </a>
                <a href="<?php echo e(route('contact')); ?>" class="border-1 border-white hover:text-[#3b0764] text-white font-medium py-1.5 px-4 sm:py-2.5 sm:px-5 md:py-3 md:px-6 rounded-md transition duration-300 ease-in-out text-center text-sm sm:text-base">
