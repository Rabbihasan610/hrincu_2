@extends('admin.layouts.app', ['title' => 'Create Our Service'])
@section('panel')
<div>
    <form action="{{ route('admin.our-services.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12 col-md-8 col-lg-8">
                ...
                <button type="submit" class="btn btn-primary">@lang('Submit Service')</button>
                    ...
                    <div class="card-body" id="extra-fields-container">
                        ...
                        <div class="form-row mb-3 extra-field" data-index="{{ $index }}">
                            ...
                            <div class="col-12 options-container">
                                ...
                                <input type="text" name="form_extra_fields[{{ $index }}][options]" class="form-control options-input" placeholder="Option 1, Option 2, Option 3" value="{{ is_array($field['options'] ?? null) ? implode(', ', $field['options']) : ($field['options'] ?? '') }}" required>
                            </div>
                            @else
