                            ...
                            <tbody>
                                @forelse($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            <x-status :data="$service" :url="route('admin.sponsorship-transfer.request.status', $service->id)" />
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="{{ route('admin.sponsorship-transfer.request.show', $service->id) }}">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" class="confirmationBtn"
                                                            data-action="{{ route('admin.sponsorship-transfer.request.delete', $service->id) }}"
