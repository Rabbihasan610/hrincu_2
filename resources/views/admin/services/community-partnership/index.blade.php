@extends('admin.layouts.app', ['title' => 'Community Partnership'])
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                            ...
                            <tbody>
                                @forelse($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            <x-status :data="$service" :url="route('admin.community.partnership.status', $service->id)" />
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="javascript:void(0)" class="isShow"
                                                            data-question="Community Partnership Information"
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.community.partnership.edit', $service->id) }}">
                                                            <i class="bi bi-pencil"></i>@lang('Edit')
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.community.partnership.duplicate', $service->id) }}">
                                                            <i class="bi bi-clipboard-plus"></i>@lang('Duplicate')
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" class="confirmationBtn"
                                                            data-action="{{ route('admin.community.partnership.delete', $service->id) }}"
...
@push('breadcrumb-plugins')
    <div class="flex-wrap gap-3 d-flex">
        ...
        <a href="{{ route('admin.community.partnership.create') }}" class="btn btn-primary"> <i class="fa-solid fa-plus"></i>@lang('Add New')</a>
    </div>
@endpush
