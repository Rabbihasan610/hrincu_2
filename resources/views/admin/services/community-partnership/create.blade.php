...
@section('panel')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.community.partnership.store', @$service->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-4">
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.community.partnership.index') }}" class="btn btn-primary"><i class="bi bi-arrow-clockwise"></i>
        @lang('Back')</a>
@endpush
