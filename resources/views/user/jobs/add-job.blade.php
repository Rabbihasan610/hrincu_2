@extends('web.layouts.frontend', ['title' => 'Create Job post'])
...
@include('sections.page_banner', ['title' => 'Create Job post'])
                    ...
                    <div class="col">
                        <div class="card-bodys">
                            <div class="card-body">
                                ...
                                <form action="{{route('user.job.store')}}" method="post" style="padding-bottom: 60px;">
                                    @csrf
                                    <div class="row">

                                        <div class="col-md-6 mb-4">
                                            <label>@lang('Job Title')</label>
                                            <input required type="text" name="title" placeholder="@lang('Job Title')" class="form-control">
                                            <div style="color:red;">{{($errors->has('title'))?($errors->first('title')):''}}</div>
                                        </div>

                                        <div class="col-md-6 mb-4">
                                            <label>@lang('Job Title') @lang('Ar')</label>
                                            <input required type="text" name="title_ar" placeholder="@lang('Job Title Ar')" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <textarea required name="description" id="description" rows="6" class="form-control nicEdit" placeholder="@lang('Description')">
                                                {{ old('description') }}
                                            </textarea>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            ...
                                            <textarea required name="description_ar" id="description_ar" rows="6" class="form-control nicEdit" placeholder="@lang('Description Ar')">
                                                {{ old('description_ar') }}
                                            </textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input required type="date" class="form-control" name="deadline" placeholder="@lang('Application Deadline')">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select name="qualification" class="form-control">
                                                @foreach ($qualifications as $key => $qualification)
                                                    <option {{ old('qualification') == $key ? 'selected' : ''}} value="{{$key}}">{{__($qualification)}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select required name="jobtype" class="form-control">
                                                ...
                                                @foreach ($jobtypes as $key => $jobtype)
                                                    <option {{ old('jobtype') == $key ? 'selected' : ''}} value="{{$key}}">{{__($jobtype)}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select required name="salarytype" class="form-control">
                                                ...
                                                @foreach ($salarytypes as $key => $salarytype)
                                                    <option {{ old('salarytype') == $key ? 'selected' : ''}} value="{{$key}}">{{__($salarytype)}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select required name="salaryrange" class="form-control">
                                                ...
                                                @foreach ($salaryranges as $key => $salaryrange)
                                                    <option {{ old('salaryrange') == $key ? 'selected' : ''}} value="{{$key}}">{{__($salaryrange)}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select required name="salarycurrency" class="form-control">
                                                ...
                                                @foreach ($salarycurrencies as $key => $salarycurrency)
                                                    <option {{ old('salarycurrency') == $key ? 'selected' : ''}} value="{{$key}}">{{__($salarycurrency)}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select required name="experience" class="form-control">
                                                ...
                                                @foreach ($experiences as $key => $experience)
                                                    <option {{ old('experience') == $key ? 'selected' : ''}} value="{{$key}}">{{__($experience)}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select required name="level" class="form-control">
                                                ...
                                                @foreach ($levels as $key => $level)
                                                    <option {{ old('level') == $key ? 'selected' : ''}} value="{{$key}}">{{__($level)}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label>@lang('No. of Vacancies')</label>
                                            <input required type="text" name="vacancies" placeholder="@lang('Enter No. of Vacancies')" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-4">
                                                    ...
                                                    <select required name="country" class="custom-select form-control" id="country_id">
                                                        ...
                                                        <option {{ old('country') == $country->id ? 'selected' : ''}} value="{{$country->id}}">{{ app()->getLocale() == 'ar' ? $country->name_ar : $country->name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    ...
                                                    <div style="color:red;">{{($errors->has('district'))?($errors->first('district')):''}}</div>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <label>@lang('State/Location')</label>
                                                    <input required type="text" name="statelocation" value="{{ old('location') }}" placeholder="@lang('State/Location')" class="form-control">
