        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 mb-4">
                <div class="partnership-img text-center">
                    <img src="{{ getImage('assets/images/frontend/partnership_areas/' . @$PartnershipAreasContent?->data_values?->image, '700x548') }}"
                        class="img-fluid " alt="{{ @$PartnershipAreasContent?->lang('title') }}">
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 mb-4">
                <div class="partnership-top mb-4">
                    <h2>{{ @$PartnershipAreasContent?->lang('title') }}</h2>
                ...
                <div class="row">
                    ...
                    @foreach ($PartnershipAreasElements as $PartnershipAreaElement)
                        <div class="col-12 col-md-6 mb-4">
                            <div class="partnership-card" style="background: {{ $bgColors[$i % count($bgColors)] }};">
                                <h5>{{ @$PartnershipAreaElement?->lang('title') }}</h5>
                                <p>{{ @$PartnershipAreaElement?->lang('subtitle') }}</p>
                            </div>
                        </div>
                        @php $i++; @endphp
                    @endforeach
