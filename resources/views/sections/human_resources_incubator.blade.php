        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 mb-4 mb-md-0">
                <div class="p-4 rounded shadow-sm bg-white h-100">
                    <h1 class="fw-bold mb-3 text-primary" style="font-size: 2rem;">
                        {{ @$HumanResourcesContent?->lang('title') }}
                    </h1>
                    <p class="text-muted" style="line-height: 1.8;">
                        {{ @$HumanResourcesContent?->lang('description') }}
                    </p>
            ...
            <div class="col-12 col-md-6 text-center">
                <div class="human-resources-img position-relative">
                    <img src="{{ getImage('assets/images/frontend/human_resources_incubator/' . @$HumanResourcesContent?->data_values?->image, '700x400') }}"
