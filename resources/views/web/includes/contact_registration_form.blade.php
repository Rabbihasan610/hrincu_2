<form action="{{ route('contact.query.submit') }}" method="post">
    @csrf
    <div class="row">
        <h5>
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-4">
            <input required type="text" name="job_title" id="job_title" placeholder="@lang('Job Title')" class="form-control">
        </div>

        <div class="col-md-12 mb-4">
            <textarea required name="write_problem" id="write_problem" placeholder="@lang('Write Problem')" class="form-control"></textarea>
        </div>
