    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-gray-300">
            <div>
                ...
                <div class="flex space-x-3 text-lg">
                    @foreach ($socialMediaElements as $socialMediaElement)
                        <a href="{{ @$socialMediaElement->data_values->link }}" class="hover:text-blue-400 m-3"
                            target="_blank">@php echo @$socialMediaElement->data_values->icon @endphp</a>
                    @endforeach
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-1 text-sm">
                    <li>&gt;&gt;<a href="{{ route('user.register', ['type' => 'job-seeker']) }}">@lang('Register as a Job Seeker')</a>
                    </li>
                    <li>&gt;&gt;<a href="{{ route('user.register', ['type' => 'employer']) }}">@lang('Register as an Employer')</a>
                    </li>
                    <li>&gt;&gt;<a
                            href="{{ route('user.register', ['type' => 'service-provider']) }}">@lang('Register as a Service Provider')</a>
                    </li>
