@extends('web.layouts.frontend', ['title' => $sector?->lang('title')])

@section('content')

@include('sections.page_banner', ['title' => $sector?->lang('title')])

<section class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-8 offset-md-2">
                <div class="card px-3 acquired-head text-center">
                    <h1>{{ __('Sectors Request') }}</h1>

                    <form action="{{ route('sector.request.submit') }}" method="post">
                        @csrf
                        <input type="hidden" name="sector_id" class="form-control" value="{{ $sector->id }}">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group my-3">
                                   <textarea name="labor" id="" rows="5" class="form-control"  placeholder="{{ __('Details of required labor') }}"></textarea>
                                </div>
                            </div>
                            
                            <div class="col-12">
                                <div class="form-group my-3">
                                   <textarea name="nolabor" id="" rows="5" class="form-control"  placeholder="{{ __('No. of required labor') }}"></textarea>
                                </div>
                            </div>
